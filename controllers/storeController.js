...
exports.getStoresByHearted = async (req, res) => {
  const stores = await Store.find({
    _id: { $in: req.user.hearts }
    });
    // alternatively we could populate the hearts field in User with the actual stores (relational), similar to how we did it for author field in store.js and render
